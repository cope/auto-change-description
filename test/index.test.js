...
let tests = [
	{
		...
		response: 'Deleted {puppy} with value (sexy). Created {sexy} with value (puppy). Modified {name} from (my object) to (updated object). Modified {details.with} from (["a","few","elements"]) to (["a","few","more","elements",{"than":"before"}]).'
	}
];
